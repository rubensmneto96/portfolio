	...
	return (
		...
		>
			<div className="container flex items-center justify-between">
				<a className="text-xl font-bold text-primary flex items-center" href="#sobre">
				...
				<div className="hidden flex md:flex space-x-8">
					...
					<div id="language" className="px-10">
						<span className="font-semibold text-lg cursor-pointer text-primary px-4">
							<a href="/">PT-BR</a>
						</span>
						<span className="font-semibold text-lg cursor-pointer"><a href="/en/">EN</a></span>
					</div>
				</div>
		        ...
		        >
					<div id="language" className="px-10 py-8">
						<span className="text-xl cursor-pointer text-primary px-4"> 
							<a href="/">PT-BR</a>
						</span>
						<span className="text-xl cursor-pointer"><a href="/en/">EN</a></span>
					</div>
